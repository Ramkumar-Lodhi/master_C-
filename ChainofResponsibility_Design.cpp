...
public:
    ...
    {
     cout << " In Photo class Processing " << mTitle << " ...\n";
    }
...
private:
    void processImplementation(Photo &a) {
        cout << "In scale class Scaling photo\n";
    }
...
private:
    void processImplementation(Photo &a) {
        cout << "In RedEye class Removing red eye\n";
    }
};
...
private:
    void processImplementation(Photo &a) {
        cout << "In Filter class Applying filters\n";
    }
};
...
private:
    void processImplementation(Photo &a)
    {
        cout << "In ColorMatch class Matching colors\n";
    }
};
